var projectData = {
  ...
  , techs: ['CSS, ', 'HTML, ', 'JavaScript, ', 'jQuery']
  , contributors: []
...
, texpert: {
  ...
  , techs: ['CSS, ', 'HTML, ', 'JavaScript, ', 'Node, ', 'Express, ', 'Auth(Bcrypt, Passport), ', 'AngularJS, ', 'MongoDB, ', 'Mongoose, ', 'Sockets.io']
...
, animoos: {
  ...
  , techs: ['CSS, ', 'HTML, ', 'JavaScript, ', 'Node, ', 'Express, ', 'AngularJS, ', 'Anilist API']
  , contributors: []
...
, Other: ['Agile', 'AJAX', 'Authentication', 'RESTful routes', 'Sessions & Passport', 'TDD', 'Trello']
, 
};