var projectData = {
 ...
 gameshare: {
  ...
  , techs: ['HTML/CSS', 'JavaScript', 'Node/Express', 'Passport.js', 'PostgreSQL/Sequelize', 'Internet Game DB API']
  , contributors: []
...
//   , techs: ['HTML/CSS', 'JavaScript', 'Node/Express', 'Passport.js', 'AngularJS', 'MongoDB/Mongoose', 'Yelp & QPX API']
...
, texpert: {
    name: 'Texpert'
  , description: 'A concept app that operates as platform to connect users that require tech support to nearby users with the technical knowledge. Individual chat rooms are created to connect two users. A Mongo database maintains user data such as usernames, messages and chat sessions.'
  , roles: ['developer', 'database design', 'backend development']
  , techs: ['HTML/CSS', 'JavaScript', 'Node/Express', 'Passport.js', 'AngularJS', 'MongoDB/Mongoose', 'Socket.io']
  , contributors: ['Kyle Richardson']
...
//   , techs: ['HTML/CSS', 'JavaScript', 'Node/Express', 'AngularJS', 'Anilist API']
//   , contributors: []
...
, Frameworks: ['AngularJS', 'Express', 'Node', 'Rails', 'React', 'jQuery', 'jQuery UI', 'Bootstrap', 'Materialize']
